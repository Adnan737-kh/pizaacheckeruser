...
class AppConstants {
  ...
  // static const String baseUrl =  'https://backend.pizzachecker.xyz';
  ...
  static const String productSubCatUri = '/api/v1/products/get_variant_by_product';
  ...
  static const String extrasProductUri = 'api/v1/products/get_variant/';
  ...
  static const String customerCouponUri = '/api/v1/customer/customer_coupon';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.germany, languageName: 'German', countryCode: 'DE', languageCode: 'de'),
