...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<CustomerCouponProvider>()),
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    Provider.of<LocationProvider>(context, listen: false).checkPermission(()=>
        ...
        getCurrentLocation(context, false).then((currentPosition) {
        }), context,
    );
    ...
    return Consumer<SplashProvider>(
      builder: (context, splashProvider, child){
        ...
        MaterialApp.router(
          ...
          title: splashProvider.configModel != null ? splashProvider.configModel!.restaurantName ?? ''
              ...
              body: Stack(
                children: [
                  ...
                  if(kIsWeb && splashProvider.configModel!.cookiesManagement != null &&
                      ...
                      && !splashProvider.getAcceptCookiesStatus(splashProvider.configModel!
                          .cookiesManagement!.content)
                      && splashProvider.cookiesShow)
                    const Positioned.fill(child: Align(alignment:
                    Alignment.bottomCenter, child: CookiesView())),
