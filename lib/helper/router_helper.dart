...
class RouterHelper {
  ...
  static String getCategoryRoute(CategoryModel categoryModel ,{RouteAction? action} ) {
    ...
    return _navigateRoute('$categoryScreen?id=${categoryModel.id}&name=${categoryModel.name}&img=$imageUrl',
        route: action);  }
  ...
  static final goRoutes = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: loginScreen, builder: (context, state) => _routeHandler(context,  LoginScreen())),
      ...
      GoRoute(path: createAccountScreen, builder: (context, state) => _routeHandler(context,   CreateAccountScreen())),
