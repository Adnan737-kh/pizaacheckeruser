...
class Product {
  ...
  double? _mainPrice;
  Map<String, List<String>> _dropdownLabels = {};
  Map<String, List<String>> _dropdownSubValues = {};
  List<String>? _extraItems;
  List<Dropdown> _dropdowns = [];
  List<DropdownValues> _dropdownsValues = [];
  List<VariantValues> _variantValues = [];
  Product(
      {int? id,
        String? name,
        String? description,
        ...
        double? mainPrice,
        Map<String, List<String>>? dropdownLabels,
        Map<String, List<String>>? dropdownSubValues,
        Map<String, List<ExtraItem>>? extraItem,
    ...
    _dropdownLabels = dropdownLabels ?? {};
    _dropdownSubValues = dropdownSubValues ?? {};
    _extraItems = _extraItems;
  ...
  Map<String, List<String>> get dropdownLabels => _dropdownLabels;
  Map<String, List<String>> get dropdownSubValues => _dropdownSubValues;
  // List<String>? get extraItem => _extraItems;
  // List<String>? get dropDownIds => _extraItems;

  // Add a getter for dropdowns
  List<Dropdown>? get dropdowns => _dropdowns;
  List<DropdownValues>? get dropdownsValues => _dropdownsValues;
  List<VariantValues>? get variantValues => _variantValues;

  // Add a method to parse dropdowns from JSON
  void parseDropdowns(List<dynamic> dropdownsJson) {
    _dropdowns = dropdownsJson.map((json) => Dropdown.fromJson(json)).toList();
  }
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    if (json['variant_values'] != null) {
      ...
      json['variant_values'].forEach((v) {
        _variantValues.add(VariantValues.fromJson(v));
    ...
    // Parse dropdown information if available
    if (json['dropdowns'] != null) {
      var dropdownsJson = json['dropdowns'] as List;
      for (var dropdownJson in dropdownsJson) {
        var dropdown = Dropdown.fromJson(dropdownJson);
  ...
  Map<String, dynamic> toJson() {
    ...
    // List<Map<String, dynamic>> jsonDataList = .map((item) => item.toJson()).toList();
...
class Dropdown {
  int? id;
  String? name;
  List<DropdownItem>? subValues;

  Dropdown({this.id, this.name, this.subValues});

  factory Dropdown.fromJson(Map<String, dynamic> json) {
    List<dynamic>? subValuesJson = json['sub_value'];
    List<DropdownItem>? subValues;
    if (subValuesJson != null) {
      subValues = subValuesJson.map((item) => DropdownItem.fromJson(item)).toList();
    }
...
class DropdownItem {
  ...
  factory DropdownItem.fromJson(Map<String, dynamic> json) {
    return DropdownItem(
      id: json['id'],
      dropdownId: int.tryParse(json['dropdown_id'].toString()),
      value: json['value'],
    );
  }
}
...
class VariationValue {
  ...
  VariationValue.fromJson(Map<String, dynamic> json) {
    ...
    optionId = int.tryParse(json['optionId'].toString());
  }
...
class DropdownValues {
  ...
  DropdownValues({this.name});

  DropdownValues.fromJson(Map<String, dynamic> json) {
    name = json['name'];
  }
