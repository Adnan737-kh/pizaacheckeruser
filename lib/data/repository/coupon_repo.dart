...
class CouponRepo {
  ...
  Future<ApiResponse> getCouponList({String? guestId}) async {
    try {
      final response = await dioClient!.get(guestId != null
          ? '${AppConstants.couponUri}?guest_id=$guestId'
          : AppConstants.couponUri);
  ...
  Future<ApiResponse> getCustomerCouponList({String? guestId}) async {
    try {
      final response = await dioClient!.get(guestId != null ? ''
          '${AppConstants.customerCouponUri}?guest_id=$guestId' : AppConstants.customerCouponUri,
