  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          child: WebAppBar()) : null,

      body: !configModel.loyaltyPointStatus! ? const NoDataScreen() :
      Consumer<ProfileProvider>(
          builder: (context, profileProvider, _) {
            return _isLoggedIn ? (!profileProvider.isLoading && profileProvider.userInfoModel != null) ?
              ...
              return Stack(children: [
                Column(children: [
                  Center(child: Container(
                    ...
                    child: SafeArea(child: Column(children: [
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          profileProvider.isLoading ? const SizedBox()
                  ...
                  Expanded(child: RefreshIndicator(
                    onRefresh: () async{
                      walletProvider.getLoyaltyTransactionList('1', true,false,
                                            ...
                                            return Column(children: [
                                              Column(children: [
                                                ...
                                                walletProvider.transactionList != null
                                                    ? walletProvider.transactionList!.isNotEmpty ? GridView.builder(
                                                  key: UniqueKey(),
                                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                    crossAxisSpacing: 50,
                                                    mainAxisSpacing: ResponsiveHelper.isDesktop(context)
                                                        ? Dimensions.paddingSizeLarge : 0.01,
