  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OrderProvider>(builder: (ctx, orderProvider, _) {
      ...
      bool isPartialPayment = authProvider.isLoggedIn()
          && splashProvider.configModel!.isPartialPayment!
      ...
      bool isSelected = (orderProvider.paymentMethodIndex == 1
      ...
      return isPartialPayment ? Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            InkWell(
              onTap: (){
                if(orderProvider.partialAmount != null || isSelected){
                  ...
                  orderProvider.saveWalletPayment(null);
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: orderProvider.partialAmount != null || isSelected
                      ? Theme.of(context).cardColor : Theme.of(context).primaryColor,
                  border: Border.all(color: orderProvider.partialAmount != null
                      || isSelected ? Colors.red : Theme.of(context).primaryColor, width: 0.5),
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                ),
          ...
          isSelected ? Text(
            '${getTranslated('remaining_wallet_balance', context)}:'
                ' ${PriceConverter.convertPrice(profileProvider.userInfoModel!.walletBalance!
                - totalPrice)}',
            style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
          ) : const SizedBox(),
