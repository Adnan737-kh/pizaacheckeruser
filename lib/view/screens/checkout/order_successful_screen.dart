  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: (ResponsiveHelper.isDesktop(context)
          ...
          : ResponsiveHelper.isWeb() || ResponsiveHelper.isMobile() ? CustomAppBar(context: context,
        isBackButtonExist: true, title: '',)
      ...
      body: SafeArea(
        child: Consumer<OrderProvider>(
            ...
            return orderProvider.isLoading ? const Center(child: CircularProgressIndicator()) : SingleChildScrollView(
              child: Column(
                children: [
                 Container(
