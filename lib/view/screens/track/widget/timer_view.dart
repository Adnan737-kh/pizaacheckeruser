          ...
          return Column( children: [
            ...
            Text(
              minutes != null && minutes < 5
                  ? getTranslated('be_prepared_your_food', context) ?? 'Be prepared, your food is almost ready!'
                  : getTranslated('your_food_delivery', context) ?? 'Your food is on its way!',
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text(
                '${(minutes ?? 0) < 5 ? 0 : (minutes ?? 0) - 5} - ${(minutes ?? 0) < 5 ? 5 : minutes ?? 0}',
