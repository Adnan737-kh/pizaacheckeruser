      ...
      body: Consumer<OrderProvider>(
        builder: (context, order, index) {
          ...
          if(order.runningOrderList != null) {
            orderList = isRunning ? order.runningOrderList!.reversed.toList()
                    ...
                    child: SizedBox(
                      ...
                      child: ResponsiveHelper.isDesktop(context) ?  GridView.builder(
                        gridDelegate:  const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,
                            crossAxisSpacing: Dimensions.paddingSizeDefault, childAspectRatio: 3/1),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) =>
                            OrderItem(orderProvider: order, isRunning: isRunning,
