  ...
  Widget build(BuildContext context) {
    return Consumer<OrderProvider>(
        builder: (context, order, _) {
          if (kDebugMode) {
            print('deliveryTime or ${order.trackModel!.deliveryTime!}');
          }
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  children: [
                    ...
                    order.trackModel!.deliveryTime != null ? Text(
                      DateConverter.deliveryDateAndTimeToDate(order.trackModel!.deliveryDate!,
                           context),
                      style: rubikRegular,
                    ) : Text(
                  ...
                  onPressed: () {
                    if(order.trackModel!.deliveryAddress != null) {
                      RouterHelper.getMapRoute(AddressModel(),
                          deliveryAddress: order.trackModel!.deliveryAddress!);
                    } else{
                ...
                Expanded(flex: 8, child: Row(children: [
                  Text(
                    ...
                    (order.trackModel!.paymentMethod != null
                        && order.trackModel!.paymentMethod!.isNotEmpty)
                        ? '${order.trackModel!.paymentMethod![0].toUpperCase()}'
                        '${order.trackModel!.paymentMethod!.substring(1).replaceAll('_', ' ')}'
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Flexible(child: ProductTypeView(productType:
                              order.orderDetails![index].productDetails!.productType,)),
                            ],
                          ),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: order.orderDetails![index].productDetails!.dropdownsValues != null
                                ? [
                              Text(
                                order.orderDetails![index].productDetails!.dropdownsValues!
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: order.orderDetails![index].productDetails!.variantValues != null
                                ? [
                              Text(
                                order.orderDetails![index].productDetails!.variantValues!
