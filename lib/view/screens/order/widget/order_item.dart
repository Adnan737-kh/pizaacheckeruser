...
class OrderItem extends StatelessWidget {
  ...
  const OrderItem({Key? key,
    required this.orderProvider,
    required this.isRunning,
    required this.orderItem}) : super(key: key);
      ...
      child: Column(children: [
        ...
        SizedBox(
          ...
          child: Row(children: [
            ...
            Expanded(child: orderItem.orderType != 'pos' && orderItem.orderType != 'dine_in'
                ? CustomButton(btnTxt: getTranslated(isRunning ? 'track_order' : 'reorder', context),
              onTap: () async {
                if(isRunning) {
                  ...
                  (await orderProvider.getOrderDetails(orderItem.id.toString()))!;
                    ...
                    if(orderDetail.productDetails != null && orderDetail.productDetails!.id != null) {
                      ...
                      if(product != null && product.variations != null && orderDetail.variations != null ) {
                        ...
                        cartList.add(CartModel(
                          orderDetail.price,
                          PriceConverter.convertWithDiscount( orderDetail.price,
                              orderDetail.discountOnProduct, 'amount'),
                          product.variations ?? [],
                          orderDetail.discountOnProduct,
                          orderDetail.quantity,
                          orderDetail.taxAmount,
                          addOnList, orderDetail.productDetails,
                          selectedVariations,
                          ['8','9','10'],
                          ['11','12','13'],
                          0.0,
