...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  final List<String?> hintList = [
    getTranslated('how_it_work_text1', Get.context!),
    getTranslated('how_it_work_text2', Get.context!),
    getTranslated('how_it_work_text3', Get.context!),
    getTranslated('how_it_work_text4', Get.context!),
    // '${getTranslated('they_register', Get.context!)}'
    //     ' ${AppConstants.appName} ${getTranslated('with_special_offer', Get.context!)}',
