...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      const MenuScreenWeb() : Consumer<AuthProvider>(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Container(
                      ...
                      child: ClipOval(
                        child: authProvider.isLoggedIn() ? FadeInImage.assetNetwork(
                          ...
                          imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholderUser, 
                    ...
                    Column(children: [
                      ...
                      authProvider.isLoggedIn() ? profileProvider.userInfoModel != null ? Text(
                        ...
                        style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeExtraLarge, 
                            color: Colors.white),
                      ),
                      ...
                      authProvider.isLoggedIn() && splashProvider.configModel!.loyaltyPointStatus! 
                          && profileProvider.userInfoModel != null ? Text(
                        '${getTranslated('loyalty_point', 
                            context)}: ${profileProvider.userInfoModel?.point?.toInt() ?? ''}',
                        style: rubikRegular.copyWith(color: Colors.white),
                      ) : const SizedBox(),
