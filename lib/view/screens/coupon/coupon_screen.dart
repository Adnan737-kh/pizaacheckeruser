...
class _CouponScreenState extends State<CouponScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn || splashProvider.configModel!.isGuestCheckout!) {
      ...
      Provider.of<CustomerCouponProvider>(context, listen: false).getCustomerCouponList();
    }
          ...
          Expanded(
            child: ListView(
              children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: width > 700
                                        ...
                                        boxShadow: [BoxShadow(color: Theme.of(context).shadowColor,blurRadius: 5, spreadRadius: 1)],)
                                          : null,
                                      child: ListView.builder(itemCount: coupon.couponList!.length,
                                          ...
                                          return Padding(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                ...
                                                showCustomSnackBar(
                                                    getTranslated('coupon_code_copied', context), isError: false);
                                              },
                                              child: Stack(children: [
                                                Image.asset(
                                                    Images.couponBg, height: 100, width: 1170,
                                                    fit: BoxFit.fitWidth, color: Theme.of(context).primaryColor),
                                                Container(height: 100, alignment: Alignment.center,
                                                  child: Row(children: [
                                                    const SizedBox(width: 50),
                                                    Image.asset(
                                                        Images.percentage, height: 50, width: 50),
                                                    Padding(
                ...
                Consumer<CustomerCouponProvider>(
                  builder: (context, coupon, child) {
                    return coupon.couponList != null
                        ? coupon.couponList!.isNotEmpty
                        ? RefreshIndicator(
                      onRefresh: () async {
                        await Provider.of<CustomerCouponProvider>(context,
                            listen: false).getCustomerCouponList();
                      },
                      backgroundColor: Theme.of(context).primaryColor,
                      child: Scrollbar(
                        child: SingleChildScrollView(
                            ...
                            children: [
                              Center(
                                child: ConstrainedBox(
                                  ...
                                  child: Container(
                                    padding: width > 700 ? const EdgeInsets.all(Dimensions.paddingSizeLarge)
                                        : EdgeInsets.zero,
                                    child: Container(
                                      width: width > 700 ? 700 : width,
                                      padding: width > 700
                                      ...
                                      child: ListView.builder(
                                        ...
                                        padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                                        itemBuilder: (context, index) {
                                          print('my code${coupon.couponList![index].code!}');
                                          return Padding(
                                            padding: const EdgeInsets
                                                .only(bottom: Dimensions.paddingSizeLarge),
                                            child: InkWell(
                                              onTap: () {
                                                Clipboard.setData(
                                                    ClipboardData(
                                              ...
                                              child: Stack(children: [
                                                Image.asset(Images.couponBg, height: 100, width: 1170, fit: BoxFit.fitWidth,
                                                ...
                                                Container(
                                                  ...
                                                  child: Row(children: [
                                                    ...
                                                    Padding(
                                                      padding: const EdgeInsets
                                                          .symmetric(horizontal: Dimensions.paddingSizeLarge,
                                                          vertical: Dimensions.paddingSizeSmall),
                                                      child: Image.asset(
                                                          Images.line,
                                                          height: 100,
                                                    ...
                                                    Expanded(
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: [
                                                            SelectableText(coupon.couponList![index].code!,
                                                              style: rubikRegular.copyWith(color: Colors.white),),
                                                            const SizedBox(
                                                            ...
                                                            const SizedBox(
                                                                height: Dimensions
                                                                    .paddingSizeExtraSmall),
                                                            Text(
                                                              '${getTranslated('valid_until', context)} '
                                                                  '${DateConverter.isoStringToLocalDateOnly(coupon.couponList![index].expireDate!)}',
