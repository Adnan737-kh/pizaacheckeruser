        ...
        if(productList == null ) {
          ...
          GridView.builder(
            ...
            SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 5,
              childAspectRatio: 4,
              crossAxisCount: ResponsiveHelper.isDesktop(context) ? 3
                  : ResponsiveHelper.isTab(context) ? 2 : 1,
            ),
            itemCount: 12,
            itemBuilder: (BuildContext context, int index) {
              return ResponsiveHelper.isDesktop(context)
                  ? const ProductWidgetWebShimmer() : ProductShimmer(isEnabled: productList == null);
              },
        ...
        Column(children: [
          ...
          productList.isNotEmpty ? Padding(
            padding: ResponsiveHelper.isDesktop(context)
                ? const EdgeInsets.only(top: 40,bottom: 70) :  const EdgeInsets.all(0),
            ...
            prodProvider.isLoading ? Center(
              child: Padding(
                ...
                Provider.of<ProductProvider>(context, listen: false).latestPageSize! / 10).ceil())
                ? const SizedBox() :
            SizedBox(
              width: 300,
