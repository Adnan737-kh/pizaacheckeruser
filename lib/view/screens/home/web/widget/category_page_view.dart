...
class CategoryPageView extends StatelessWidget {
  ...
  const CategoryPageView({Key? key, required this.categoryProvider,
  ...
  Widget build(BuildContext context) {
    ...
    return PageView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          (index + 1 == totalPage)
              ? initialLength = categoryProvider.categoryList!.length - (index * 7)  : 7;
          return ListView.builder(
            itemCount: initialLength, scrollDirection: Axis.horizontal,
                  ...
                  builder: (isHover) {
                    return Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () => RouterHelper.getCategoryRoute(categoryProvider.categoryList![currentIndex0]),// arguments:  category.categoryList[index].name),
                        child: Column(children: [
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: FittedBox(
                                child: Text(
                                    name!, style: rubikMedium.copyWith(color: isHover
                                    ? Theme.of(context).primaryColor
                                    : Theme.of(context).textTheme.bodyLarge?.color), maxLines: 1, overflow: TextOverflow.ellipsis),
                              ),
                            ),
                          ),
