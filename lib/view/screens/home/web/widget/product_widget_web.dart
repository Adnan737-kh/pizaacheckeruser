...
class ProductWidgetWeb extends StatelessWidget {
  ...
  const ProductWidgetWeb({Key? key, required this.product,
    this.fromPopularItem = false}) : super(key: key);
  ...
  Consumer<CartProvider> _itemView(bool isAvailable, double? priceDiscount, double? startingPrice) {
    return Consumer<CartProvider>(
        builder: (context, cartProvider, child) {
          ...
          String productImage = '';
          try{
            productImage =  '${Provider.of<SplashProvider>(context,
                listen: false).baseUrls!.productImageUrl}/${product.image}';
          }catch(e) {
            debugPrint('error ===> $e');
          }
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: FadeInImage.assetNetwork(
                                ...
                                fit: BoxFit.cover, height: 105, width: 195,
                                image: productImage,
                                imageErrorBuilder: (c, o, s) =>
                                    Image.asset(Images.placeholderRectangle,
                                        fit: BoxFit.cover,  height: 105, width: 195),
                              ),
                            ),
                            ...
                            isAvailable ? const SizedBox() : Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(borderRadius: const
                                BorderRadius.vertical(top: Radius.circular(10)), color: Colors.black.withOpacity(0.6)),
                                ...
                                child: SizedBox(
                                  ...
                                  child: FittedBox(
                                      child: ElevatedButton(
                                          style : ElevatedButton.styleFrom(backgroundColor: Theme.of(context).primaryColor, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5))),
                                          onPressed:() => _addToCart(context, cartIndex),
                                          child: Text(getTranslated('quick_view', context)!,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.white))
                                      )),
                                ),
                              ),
                            ]),
