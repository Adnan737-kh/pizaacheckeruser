      ...
      builder: (context, setMenu, child) {
        return Column(
          children: [
            ...
            SizedBox(
              height: 360,
              child: setMenu.setMenuList != null ? setMenu.setMenuList!.isNotEmpty
                  ? SetMenuPageView(setMenuProvider: setMenu, pageController: pageController) : Center(child: Text(getTranslated('no_set_menu_available', context)!)) : const SetMenuShimmer(),
            ),
          ],
        );
      },
