  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: ResponsiveHelper.isTab(context)
          ? const Drawer(
          child: OptionsView(onTap: null)) : const SizedBox(),
  ...
  Scrollbar _scrollView(ScrollController scrollController, BuildContext context) {
    return Scrollbar(
          ...
          child: CustomScrollView(controller: scrollController, slivers: [
            ...
            const SliverToBoxAdapter(child: SizedBox()) : SliverAppBar(
                floating: true,
                elevation: 0,
                centerTitle: false,
                    ...
                    return Row(
                      ...
                      children: [
                        ResponsiveHelper.isWeb() ? FadeInImage.assetNetwork(
                          ...
                          '${splash.baseUrls!.restaurantImageUrl}'
                              '/${splash.configModel!.restaurantLogo}' : '',
                          imageErrorBuilder: (c, o, s) =>
                              Image.asset(Images.placeholderRectangle, height: 35, width: 35),
                        ) : Image.asset(Images.logo, width: 35, height: 35),
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Padding(
                              ...
                              child: Text(getTranslated('popular_item', context)!,
