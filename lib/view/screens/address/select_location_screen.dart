...
class _SelectLocationScreenState extends State<SelectLocationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      const PreferredSize(preferredSize: Size.fromHeight(120), child: WebAppBar()) :  AppBar(
                        ...
                        child: GoogleMap(
                          ...
                          onMapCreated: (GoogleMapController controller) {
                            Future.delayed(const Duration(milliseconds: 500)).then((value) {
                              ...
                              locationProvider.pickPosition.longitude.toInt() == 0
                                  &&  locationProvider.pickPosition.latitude.toInt() == 0 ? _initialPosition : LatLng(
                        ...
                        child: Container(
                          ...
                          child: Builder(
                              builder: (context) {
                                ...
                                //   locationProvider.locationController.text = '${locationProvider.pickAddress.name ?? ''}
                                //   ${locationProvider.pickAddress.subAdministrativeArea ?? ''} ${locationProvider.pickAddress.isoCountryCode ?? ''}';
                                // }
