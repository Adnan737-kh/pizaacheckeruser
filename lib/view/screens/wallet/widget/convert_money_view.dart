...
class _ConvertMoneyViewState extends State<ConvertMoneyView> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String?>  noteList = [
      getTranslated('loyalty_pints_note1', context),
      getTranslated('loyalty_pints_note2', context),
      getTranslated('loyalty_pints_note3', context),
      getTranslated('loyalty_pints_note4', context),
      getTranslated('loyalty_pints_note5', context),
      getTranslated('loyalty_pints_note6', context),
      getTranslated('loyalty_pints_note7', context),
      getTranslated('loyalty_pints_note8', context),
      getTranslated('loyalty_pints_note9', context),
      getTranslated('loyalty_pints_note10', context),
      getTranslated('loyalty_pints_note11', context),
      getTranslated('loyalty_pints_note12', context),
