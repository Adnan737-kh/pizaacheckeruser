  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(
          width:
              ResponsiveHelper.isDesktop(context) ? width * 0.35 : width * 0.9,
          child: Align(
                ...
                if (inputAmountController.text.isNotEmpty)
                  Flexible(
                    ...
                    onTap: (index) => orderProvider.changePaymentMethod(
                      digitalMethod:
                          configModel?.activePaymentMethodList![index],
                    ),
                  ...
                  onTap: () {
                    ...
                    if (inputAmountController.text.isEmpty) {
                      ...
                      double amount = double.parse(inputAmountController.text
                          .replaceAll(configModel!.currencySymbol!, ''));
                      ...
                      String tokenUrl =
                          '${convert.base64Encode(convert.utf8.encode(ResponsiveHelper.isWeb() ? (kDebugMode ? webUrlDebug : webUrl) : url))}&&payment_platform=${kIsWeb ? 'web' : 'app'}&&is_add_fund=1';
                      String selectedUrl =
                          '${AppConstants.baseUrl}/payment-mobile?token=$tokenUrl&&payment_method=${orderProvider.paymentMethod?.getWay}';
